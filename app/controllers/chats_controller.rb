class ChatsController < ApplicationController
  ...
  this  what the output must looks like
 {
  ...
  def create_chat_dlc
    ...
    if @chat.save
      ingredients_5 = instructions_dlc
      ingredients_5_string = ingredients_5.map(&:name).join(', ')
      prompt =" make me a tasty recipe wich take in priority those ingredients #{ingredients_5_string}"
