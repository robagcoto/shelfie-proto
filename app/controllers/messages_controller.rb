...
class MessagesController < ApplicationController
  ...
  The recipe must contain:
    ...
    "ingredients" with this measurements exclusively : ['l', 'g', 'pc(s)']
...
def create
  ...
  if @message.save
    ...
    @assistant_message = @chat.messages.create!(prompt: response.content, role: :assistant, user_id: current_user.id)
