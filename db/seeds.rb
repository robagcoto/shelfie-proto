...
IngredientsRecipe.create!(name: "spaghetti", quatity: 200, unit: "g", recipe_id: recipe1.id)
IngredientsRecipe.create!(name: "eggs", quatity: 2, unit: "pc(s)", recipe_id: recipe1.id)
IngredientsRecipe.create!(name: "cheese", quatity: 100, unit: "g", recipe_id: recipe1.id)
IngredientsRecipe.create!(name: "bacon", quatity: 100, unit: "g", recipe_id: recipe1.id)
