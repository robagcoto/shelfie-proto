...
ingredients_data = [
  ...
  { name: "broccoli", storage_method: "Fridge", category: "Vegetables", quantity: 5, unit: "pc(s)", expiration_days: 5 },
  { name: "spinach", storage_method: "Fridge", category: "Vegetables", quantity: 2, unit: "pc(s)", expiration_days: 5 },
  { name: "lettuce", storage_method: "Fridge", category: "Vegetables", quantity: 1, unit: "pc(s)", expiration_days: 7 },
  ...
  { name: "butter", storage_method: "Fridge", category: "Dairy and eggs", quantity: 1000, unit: "g", expiration_days: 60 },
  { name: "chicken breast", storage_method: "Fridge", category: "Meats", quantity: 3, unit: "pc(s)", expiration_days: 2 },
  { name: "beef steak", storage_method: "Fridge", category: "Meats", quantity: 2, unit: "pc(s)", expiration_days: 4 },
  { name: "pork chop", storage_method: "Fridge", category: "Meats", quantity: 2, unit: "pc(s)", expiration_days: 4 },
  { name: "fish fillet", storage_method: "Fridge", category: "Fish and seafood", quantity: 4, unit: "pc(s)", expiration_days: 2 },
  { name: "shrimp", storage_method: "Freezer", category: "Fish and seafood", quantity: 12, unit: "pc(s)", expiration_days: 6 },
  { name: "pea", storage_method: "Freezer", category: "Vegetables", quantity: 1000, unit: "g", expiration_days: 4 },
  { name: "cheddar cheese", storage_method: "Fridge", category: "Dairy and eggs", quantity: 2000, unit: "g", expiration_days: 28 },
...
# HouseIngredient.create!(expiration_date: DateTime.now + 30, quantity: 4,  unit: 'pc(s)', house_id: house1.id, ingredient_id: ing2.id)
# puts "ingredient 2 added to cart 🛒"
